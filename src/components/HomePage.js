  ...
  return (
    <div>
      <section className='about-me'>
        ...
        <div className="profile">
          ...
          <div className="profile__name">Takanobu Harada</div>
          <div className="profile__desc">静岡大学情報学部行動情報学科3年。興味のままにフロントエンド(Javascript/React等)とバックエンド(Python,Django,Java等)を勉強中。英検1級にも挑戦中。
          </div>
        </div>      
      </section>
    ...
    <section className='about-career'>
      ...
      <div className = "career">
        ...
        <li>
          <p className='timeline-date'>2022年8月</p>
          <div className='timeline-content'>
            <h4>1週間のインターンシップ参加</h4>
            <p>KotlinとPythonを用いたアプリケーション開発を体験</p>
          </div>
        </li>
        <li>
